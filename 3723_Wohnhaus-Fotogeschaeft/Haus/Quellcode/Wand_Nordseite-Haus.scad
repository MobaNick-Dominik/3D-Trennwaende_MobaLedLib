...
x_all = 54;  //Breite der Wand = Breite der Grundplatte
...
y_dachschraege = 22;    // Hoehe Dachgeschoss
...
difference(){
    HauptWand();
    Fenster(-24.75,12.00,10.75,14.0);
    Fenster(16.25,17.00,6.75,7.25);
    Fenster(1,40.00,11.50,9.50);
    Fenster_Rund(3.75,21.00,5.00);
}
